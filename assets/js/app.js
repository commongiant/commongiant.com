// Maps
		var map = L.map('map', {
			center: [36.093274, -80.246823],
			zoom: 15,
			scrollWheelZoom: false,
		});
		
	L.tileLayer('http://{s}.tile.cloudmade.com/{key}/{styleId}/256/{z}/{x}/{y}.png', {
    key: '2dc22b00437844fab17dd079cb33e22c',
    styleId: 77922,
    maxZoom: 18,
    minZoom: 13,
}).addTo(map);
	...
	var myIcon = L.icon({
    iconUrl: 'assets/img/cg_pin.png',
    iconRetinaUrl: 'assets/img/cg_pin.png',
    iconSize: [67, 67],
    iconAnchor: [30, 30],
	});

	L.marker([36.093274, -80.246823],  {icon: myIcon}).addTo(map).bindPopup('<a target="_blank" href="https://maps.google.com/maps?ie=UTF-8&q=commongiant&fb=1&gl=us&hq=commongiant&cid=0,0,14013186940281588678&ei=hg4uUr7fEcW64APerIDYCA&ved=0CIkBEPwSMA8">185 S. Marshall St.</a>').closePopup();
...
/*********************************************************************
	...
	*/
	...
	twitterFetcher.fetch('377145224494993408', function(html){
